...
@router.post("/projects/", response_model=ProjectDetails, status_code=status.HTTP_201_CREATED)
def create_project(project: ProjectDetails):
    projects_db.append(project)
    return project

@router.get("/projects/", response_model=List[ProjectDetails])
def get_projects():
    return projects_db

@router.get("/projects/{project_name}", response_model=ProjectDetails)
...
@router.put("/projects/{project_name}", response_model=ProjectDetails)
